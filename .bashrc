...
#######################################################
# SOURCED ALIAS'S AND SCRIPTS BY EnigmaHysterico
#######################################################
...
alias baba='google-chrome'
#alias conda='anaconda-navigator'
alias fire='firefox'
alias find='sudo find / -iname'
alias gdnt='shutdown 1'
alias hack='hollywood'
alias oiran='gedit ~/.bashrc'
alias googly='xeyes'
alias refresh='source ~/.bashrc'
alias matrix='cmatrix'
alias dna='vim ~/.bashrc'
alias x= 'exit'
...
alias source1='source devel/setup.bash'
...
alias sleep='sudo shutdown -r now'
alias sleepnow='sudo shutdown -r -n now'
